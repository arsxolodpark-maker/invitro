...
const demoDirections: DemoDirection[] = [
  ...
  },
  {
    ...
    mappingRows: [{ kind: 'Услуга', invitroCode: 'NMU-2001', invitroName: 'Услуга INVITRO · DEMO', vendorCode: 'V-SVC-88', vendorName: 'Услуга в МИС/ЛИС · DEMO', status: 'Нет маппинга' }],
    stages: [
  ...
  },
  {
    ...
    mappingRows: [{ kind: 'Услуга', invitroCode: 'NMU-3001', invitroName: 'Услуга INVITRO · DEMO', vendorCode: 'V-SVC-99', vendorName: 'Услуга в МИС/ЛИС · DEMO', status: 'Нет маппинга' }],
    stages: [
