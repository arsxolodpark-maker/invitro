    ...
    return (
      <div className="max-w-xl mx-auto py-10">
        <div className="bg-white border border-[#dfeaea] rounded-2xl p-7 shadow-sm space-y-5">
          ...
          <div className="text-[11px] text-slate-400">Самостоятельную регистрацию не показываем: подробный UC v9 описывает приглашение через ДКП. Конфликт с общим ФТ остается TBD.</div>
        </div>
      </div>
    );
  }
